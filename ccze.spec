...
License:		GPLv2+
Source:			https://github.com/madhouse/ccze/archive/ccze-%{version}.tar.gz
...
%changelog
* Fri Jul 24 2020 Daniel Pawlik <dpawlik@redhat.com> - 0.2.1-25
- changed source repository to official
- create configure file using autoconf and autoheader
